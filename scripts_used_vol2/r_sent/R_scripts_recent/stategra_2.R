...
library(parallel)
# oct 22
mirna_gbm_norm<-readRDS("/home/bianca/Desktop/de_p_8_normal_values")
rna_gbm_norm<-readRDS("/home/bianca/Desktop/de_r_8_normal_values")
...
discoRes <- omicsCompAnalysis(Input=list(B1, B2), Names=c("expr", "proteins"),
                              method="DISCOSCA", Rcommon=2, Rspecific=c(3, 3),
                              center=F, scale=F, weight=TRUE)
