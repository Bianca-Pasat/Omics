...
pdat <- read.table("pdat.project.txt",header=TRUE,stringsAsFactors = FALSE)
...
celfiles.updated = list.files(path = ".", pattern = ".CEL$", all.files = FALSE,
full.names = FALSE, recursive = FALSE, ignore.case = FALSE)


affyRaw <- read.celfiles(celfiles.updated, phenoData = pdat) # has also arguments for phenotype information, pdata argument
# add later after importing the celfiles

affyRaw <- read.celfiles(celfiles.updated)
